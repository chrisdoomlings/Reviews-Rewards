...
/* ── Back-to-account bar ── */
.account-bar{background:#f9fafb;border-bottom:1px solid #e5e7eb;padding:12px 20px}
.account-bar .wrap{display:flex;align-items:center;justify-content:space-between}
.account-bar a{color:#5b21b6;text-decoration:none;font-size:14px;font-weight:600;display:inline-flex;align-items:center;gap:6px}
